...
class NeuralController : public controller_interface::ControllerInterface {
 ...
 protected:
  ...
  // Publish actuator commands generated by neural controller
  std::shared_ptr<rclcpp::Publisher<std_msgs::msg::Float64MultiArray>> controller_output_pub_ =
      nullptr;
  std::shared_ptr<realtime_tools::RealtimePublisher<std_msgs::msg::Float64MultiArray>>
      realtime_controller_output_pub_ = nullptr;
